        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="../assets/img/Profil/WhatsApp Image 2022-06-23 at 04.09.37.jpeg" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
                ...
                <h3>Rp 55.000</h3>
                <div class="row">
                    <button type="button" class="btn-harga">10 pcs</button>
                    <button type="button" class="btn-harga">20pcs</button>
                    <button type="button" class="btn-harga">30pcs</button>
                </div>

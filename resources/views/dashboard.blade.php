...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="active" href="{{route('dash')}}">Home</a></li>
  ...
  <main id="main">
    ...
    <!-- ======= Title Section ======= -->
    <section class="title-dash" data-aos="fade-up" data-aos-easing="ease-in-out" date-aos-delay="200">
      <div class="container">
        <div class="row">
            <div class="pg col-1 ">
            ...
            <div class="text col-11 my-auto">
                <h1 class="title">Fitur Administrasi</h1>
            </div>
        </div>
      </div>
    </section>
    ...
    <!-- ======= dashboard Section ======= -->
    <section class="main-dash" data-aos="fade-up" data-aos-easing="ease-in-out" date-aos-delay="200">
     <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4 d-flex justify-content-center" data-aos="fade-up" data-aos-delay="200">
          <div class="icon-box icon-box-orange">
            ...
            <div class="icon"></div>
            <h1 class="title"><a href="{{route('adminproduk')}}">Admin Produk</a></h1>
          </div>
        </div>

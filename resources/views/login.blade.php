...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Title Section ======= -->
    <section class="title-login" data-aos="fade-up" data-aos-easing="ease-in-out" date-aos-delay="200">
      <div class="container">
        <div class="row">
            <div class="pg col-1 ">
    ...
    <!-- ======= Title Section ======= -->
    <section class="desc-login" data-aos="fade-up" data-aos-easing="ease-in-out" date-aos-delay="200">
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
            @if(session('error'))
